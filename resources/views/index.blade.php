                        ...
                        <ul class="todo-list ui-sortable">
                            @foreach($backup['files'] as $file)
                                <li>
                                    ...
                                    <div class="tools">
                                        <a target="_blank"
                                           href="{{ route('backup-download', ['disk' => $backup['disk'], 'file' => $backup[0].'/'.$file]) }}"><i
                                                    class="fa fa-download"></i></a>
                                        <a href="{{ route('backup-delete', ['disk' => $backup['disk'], 'file' => $backup[0].'/'.$file]) }}"
                                           class="backup-delete"><i class="fa fa-trash-o"></i></a>
                                    </div>
                                </li>
                            @endforeach
                        </ul>
